...
function organizeFn(dirPath){
    ...
    // 3. check--> all files OR identify categories of all the files present in that input directory
}
...
function organizedHelper(src,dest) {
    ...
    for(let i = 0; i<childNames.length; i++){
        ...
        if(isFile){
            ...
            sendFiles(childAddress,dest,category);  //copy and send file in category folder
